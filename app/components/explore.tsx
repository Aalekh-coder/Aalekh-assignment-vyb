    ...
    <div>
      ...
      <div>
        ...
        <div className="flex gap-2 mx-3 sm:px-5 sm:py-8 md:gap-8 xl:gap-14">
          <div
            className="h-[16rem] w-[10rem] bg-contain bg-no-repeat -z-30 rounded-xl sm:h-[30rem] sm:w-[20rem] md:h-[35rem]"
          ...
          <div
            className="hidden lg:block h-[16rem] w-[10rem] bg-contain bg-no-repeat -z-30 rounded-xl sm:h-[30rem] sm:w-[20rem] md:h-[35rem]"
            style={{ backgroundImage: "url('/assets/darjeeling.png')" }}
          >
            <img
              src="/assets/text3.png"
